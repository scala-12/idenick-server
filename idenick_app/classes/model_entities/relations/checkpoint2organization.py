...
class Checkpoint2Organization(AbstractEntry):
    ...
    checkpoint = models.ForeignKey(
        'Checkpoint', db_column='devicegroupsid', related_name='organizations', on_delete=models.CASCADE)
    organization = models.ForeignKey(
        'Organization', db_column='companyid', related_name='checkpoints', on_delete=models.CASCADE)
